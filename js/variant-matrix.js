...
import { SIZES, VARIANT_TYPES, emptyVariant, STORAGE_LOCATIONS } from "./constants.js";
...
export function renderVariantTable(variants) {
  ...
  const rows = variants.map((v, i) => `
    <tr data-idx="${i}">
      ...
      <td data-label="Sample"><input class="v-sample-location" data-idx="${i}" type="text" value="${escapeHtml(v.sample_location)}" placeholder="e.g. Front window" /></td>
