...
export function renderVariantTable(variants) {
  ...
  const rows = variants.map((v, i) => `
    <tr data-idx="${i}">
      ...
      <td><input class="v-location" data-idx="${i}" type="text" list="vm-storage-locations" value="${escapeHtml(v.location)}" placeholder="A1" /></td>
      <td><input class="v-sample-location" data-idx="${i}" type="text" value="${escapeHtml(v.sample_location)}" placeholder="e.g. Front window" /></td>
