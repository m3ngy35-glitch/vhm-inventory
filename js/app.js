  ...
  return `
    <div class="product-card" data-id="${p.id}">
      ...
      <div class="card-locations">
        <span class="loc-chip loc-chip-storage">Storage: ${p.storage_location ? escapeHtml(p.storage_location) : "—"}</span>
        <span class="loc-chip loc-chip-sample">Sample: ${p.sample_location ? escapeHtml(p.sample_location) : "—"}</span>
      </div>
      <div class="card-body">
