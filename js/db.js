...
// Inline product-level patch (quick-edit without reopening the modal) —
// used for fields that belong to the product as a whole rather than to any
// one variant, like the storage/sample location chips on the card.
