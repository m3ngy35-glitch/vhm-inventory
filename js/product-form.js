...
import { VARIANT_TYPES, sizesForType, COLOR_SUGGESTIONS } from "./constants.js";
    ...
    <div class="modal modal-lg">
      ...
      <div class="modal-body">
        ...
        <label>Description (Markdown supported, searchable)
          <textarea id="f-description" rows="3" placeholder="Fabric, fit, care notes...">${escapeHtml(state.description)}</textarea>
        </label>
